...
const articles = [
  { type: 'International', highlight: "AI is a black box maybe not for long", detail: "No One Truly Knows How AI Systems Work. A New Discovery Could Change That", passage: "This is a passage for the first article to give more detail.", imageUrl: Card1, author: 'Author1', date: '2024-05-16' },
      ...
      <div className="min-h-screen bg-[#F0F4F8] p-10 py-[10vh] flex justify-center shadow-sm">
        <div className="w-4/5">
          ...
          <div className="pb-12 border-t border-black pt-10">
            <h2 className="text-3xl font-medium  pb-4 font-raleway text-[#222f3d]">More in International-</h2>
