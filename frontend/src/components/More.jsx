      ...
      <div className="bg-white text-gray-800">
        ...
        <div className="relative w-full h-[570px] bg-cover bg-center" style={{ backgroundImage: `url(${CampusNITR})` }}>
          ...
          <div className="relative z-10 flex items-center justify-center h-full px-4 text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white">We are the voice of youth and students</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 relative">
            ...
            <div className="flex flex-col h-[1000px] lg:flex-row justify-around gap-6 lg:h-[375px]">
