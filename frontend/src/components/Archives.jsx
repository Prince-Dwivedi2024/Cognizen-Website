...
const MoreInArchivesCard = ({ type, description, title, photo1, author, publishDate, onReadMore }) => {
  ...
  return (
    <div className="flex border-b border-gray-300 dark:border-gray-700 py-4" onClick={() => handleReadMore}>
  ...
  return (
    <>
      ...
      {loader ? (
        ...
        <div className="min-h-screen bg-[#F0F4F8] dark:bg-[#121212] p-10 pt-2 flex justify-center shadow-sm">
          <div className="w-4/5">
            <div className="pb-12">
              <h2 className="text-3xl font-medium font-serif pt-16 pb-2 text-[#222f3d] dark:text-[#f5f5f5] underline underline-offset-8">ARCHIVES ARTICLES -</h2>
            ...
            <div className="pb-12 border-t border-black dark:border-gray-700 pt-10">
              <h2 className="text-3xl font-medium pb-8 font-serif text-[#222f3d] dark:text-[#f5f5f5] underline underline-offset-8">MORE IN ARCHIVES -</h2>
