//user landing page for articles related to Opinion tab
...
const MoreInOponionCard = ({ type, highlight, detail, imageUrl, author, date, onReadMore }) => (
    ...
    <>
      ...
      <div className="min-h-screen bg-[#F0F4F8] p-10 pt-2 flex justify-center shadow-sm">
        <div className="w-4/5">
          ...
          <div className="pb-12">
            <h2 className="text-3xl font-medium mb-4 font-raleway pt-10 pb-4 text-[#222f3d]">Oponion Articles-</h2>
          ...
          <div className="pb-12 border-t border-black pt-10">
            <h2 className="text-3xl font-medium  pb-4 font-raleway text-[#222f3d]">More in Oponion-</h2>
            <div className="grid grid-cols-1 gap-4">
              {moreInOponion.map((article, index) => (
                <MoreInOponionCard key={index} {...article} onReadMore={handleReadMore} />
              ))}
            </div>
          </div>
        </div>
