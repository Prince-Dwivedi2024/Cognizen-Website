  ...
  useEffect(() => {
    const fetchHistoryArticles = async () => {
      try {
        ...
        const filteredArticles = articlesData.filter(article => article.category.toLowerCase() === 'History');
      ...
      <div className="min-h-screen bg-[#F0F4F8] p-10 pt-2 flex justify-center shadow-sm">
        <div className="w-4/5">
          ...
          <div className="pb-12 border-t border-black pt-10">
            <h2 className="text-3xl font-medium  pb-8 font-serif text-[#222f3d] underline underline-offset-8">MORE IN History -</h2>
