...
const Notice = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 mt-4 relative">
      ...
      <div className="text-sm text-orange-500 mb-2 mt-12">{notice.category}</div>
      ...
      <div className="flex items-center mb-6">
        ...
        <div>
          <p className="text-gray-700 font-bold">{notice.author}</p>
          <p className="text-gray-500">{notice.publishDate}</p>
        </div>
      </div>
